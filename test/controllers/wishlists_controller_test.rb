...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { product_variant_id: @wishlist.product_variant_id, user_id: @wishlist.user_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { product_variant_id: @wishlist.product_variant_id, user_id: @wishlist.user_id } }
